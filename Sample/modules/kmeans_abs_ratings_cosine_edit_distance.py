...
#
#     MET_AN_EN = pd.read_table(
#         '/home/shrutitejus/iit/research_project/Research_Project/Sample/modules/datastructs/training_adj_noun_met_en.txt',
#         delim_whitespace=True, names=('adj', 'noun'))
#     MET_AN_EN['class'] = 1
#     LIT_AN_EN = pd.read_table(
#         '/home/shrutitejus/iit/research_project/Research_Project/Sample/modules/datastructs/training_adj_noun_nonmet_en.txt',
#         delim_whitespace=True, names=('adj', 'noun'))
#     LIT_AN_EN['class'] = 0
#
...
#     # model = KeyedVectors.load_word2vec_format(
#     #     '/home/shrutitejus/iit/research_project/Research_Project/Sample/modules/datastructs/wiki.en.vec')
#     data = []
#     for j in zip(df.adj, df.noun):
#         temp = [j[0], j[1]]
#         data.append(temp)
...
#
#     csv = pd.read_csv(
#         "/home/shrutitejus/iit/research_project/Research_Project/Sample/modules/datastructs/AC_ratings_google3m_koeper_SiW.csv",
#         error_bad_lines=False)
#     csv = pd.DataFrame(csv)
#     dict = {}
#     csv_df = pd.DataFrame(csv['WORD\tRATING'].str.split('\t', 1).tolist(),
...
#
#     fields = ['adj', 'noun']
#     MET_AN_EN_TEST = pd.read_excel('/home/shrutitejus/iit/research_project/Research_Project/Sample/modules/datastructs/Datasets_ACL2014.xlsx', sheetname='MET_AN_EN', usecols=fields)
#     MET_AN_EN_TEST['class'] = 1
#     LIT_AN_EN_TEST = pd.read_excel('/home/shrutitejus/iit/research_project/Research_Project/Sample/modules/datastructs/Datasets_ACL2014.xlsx', sheetname='LIT_AN_EN', usecols=fields)
#     LIT_AN_EN_TEST['class'] = 0
#
